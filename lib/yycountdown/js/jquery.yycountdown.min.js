...
;(function(b){
	b.fn.yycountdown=function(f){
								var a=b.extend({
												...
												endDateTime:"2020/03/28 10:00:00",
												diffDateTime:0,unit:{d:"day",h:"hour",m:"min",s:"sec"},
												complete:null,node:{d:null,h:null,m:null,s:null},self:null,timerId:null},
												f);

												a.self=b(this);(function(){"Date"!==typeof a.complete&&(a.startDateTimeObj=new Date(a.startDateTime));
												a.endDateTimeObj=new Date(a.endDateTime);
												a.diffDateTime=Math.floor((a.endDateTimeObj-a.startDateTimeObj)/1E3);
												var g=b("<div />").addClass("yycountdown-box").attr("id","yy-box"), 
													c=b("<span />").addClass("yyc-day").attr("id","yy-day"),
													d=b("<span />").addClass("yyc-hou").attr("id","yy-hour"),
													e=b("<span />").addClass("yyc-min").attr("id","yy-min"),
