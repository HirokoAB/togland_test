...
;(function($) {
	$.fn.yycountdown = function(options){
		...
		var _initTimer = function(){
			...
			//view node setting
			var box        = $('<div />').addClass('yycountdown-box').addId('yy-box');
			var fix        = $('<div>').addClass('fix');
			var boxDay     = $('<span />').addClass('yyc-day').addId('yy-day');
			var boxHou     = $('<span />').addClass('yyc-hou');
			var fixed      = $('</div>');
			var boxMin     = $('<span />').addClass('yyc-min');
			var boxSec     = $('<span />').addClass('yyc-sec').addId('yy-sec');
			...
			box.append(fix).append(boxDay).append(boxDayText)
				.append(boxHou).append(boxHouText)
				.append(fixed).append(boxMin).append(boxMinText)
